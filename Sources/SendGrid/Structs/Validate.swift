...
struct Validate {
    ...
    /**
     ...
     Takes a given input and regex pattern and returns a `Bool` indicating if there were any matches.
     
     - parameter input:     The `String` to search.
     - parameter pattern:   The regular expression pattern, expressed as a `String` to use.
