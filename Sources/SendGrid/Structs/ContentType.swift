...
public struct ContentType: CustomStringConvertible {
    ...
    /**
     ...
     The `index` property is an internal property used to sort in priority the content type. The main use for this is to ensure conformance with [RFC 1341, Section 7.2.3](https://tools.ietf.org/html/rfc1341), which states that the various parts of an email body should be ordered in increasing order of preference. Sorting off of this property will ensure that the HTML content is given preference over the plain content.
    ...
    /**
     ...
     - parameter type:      The first part of the content type, for example `text` in `text/html`.
     - parameter subtype:   The second part of the content type, for example `html` in `text/html`.
    ...
    /**
     ...
     - parameter rawValue:    A `String` representing the value of the content type.
