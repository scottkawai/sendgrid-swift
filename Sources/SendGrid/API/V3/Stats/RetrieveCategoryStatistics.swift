...
///             // The `model` variable will be an array of `Statistic.Set` structs.
///             model.forEach { _ in
...
public extension RetrieveCategoryStatistics /* Parameters */ {
    /// The `RetrieveCategoryStatistics.Parameters` struct represents the 
    /// various parameters that can be specified with the 
    /// `RetrieveCategoryStatistics` API request.
    struct Parameters: Encodable, Validatable {
        ...
        /// date and that there are no more than 10 categories specified.
