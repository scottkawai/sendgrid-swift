...
class RetrieveSpamReportsTests: XCTestCase {
    ...
    func testGetAllInitialization() {
        ...
        XCTAssertEqual(minRequest.description, "https://api.sendgrid.com/v3/suppression/spam_reports")
        ...
        XCTAssertEqual(maxRequest.description, "https://api.sendgrid.com/v3/suppression/spam_reports?limit=4&offset=8&start_time=15&end_time=16")
    }
    
    func testEmailSpecificInitializer() {
        let request = RetrieveSpamReports(email: "foo@example.none")
        XCTAssertEqual(request.description, "https://api.sendgrid.com/v3/suppression/spam_reports/foo@example.none")
    }
